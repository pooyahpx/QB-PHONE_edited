...
$(document).on('click', '.bank-app-account', function(e){
    ...
    QB.Phone.Notifications.Add("fas fa-university", "TBanking", "Bank account No. copied!", "#badc58", 1750);
});
    ...
    if (iban != "" && amount != "") {
            $.post('http://qb-phone_new/CanTransferMoney', JSON.stringify({
                ...
                if (data.TransferedMoney) {
                    ...
                    QB.Phone.Notifications.Add("fas fa-university", "TBanking", "You have $"+amount+" transferred!", "#badc58", 1500);
                } else {
                    QB.Phone.Notifications.Add("fas fa-university", "TBanking", "You do not have enough balance!", "#badc58", 1500);
                }
                QB.Phone.Animations.TopSlideUp(".bank-app-transfer", 400, -100);
            });
    } else {
        QB.Phone.Notifications.Add("fas fa-university", "TBanking", "Fill out all fields!", "#badc58", 1750);
    }
});
    ...
    if (BankBalance >= InvoiceData.amount) {
        $.post('http://qb-phone_new/PayInvoice', JSON.stringify({
            ...
            if (CanPay) {
                ...
                QB.Phone.Notifications.Add("fas fa-university", "TBanking", "You have $"+InvoiceData.amount+" paid!", "#badc58", 1500);
...
$(document).on('click', '.bank-app-my-contact', function(e){
    ...
    if (PressedContactData.iban !== "" && PressedContactData.iban !== undefined && PressedContactData.iban !== null) {
        ...
        QB.Phone.Notifications.Add("fas fa-university", "TBanking", "There is no IBAN tied to this contact!", "#badc58", 2500);
    }
    QB.Phone.Animations.TopSlideUp(".bank-app-my-contacts", 400, -100);
});