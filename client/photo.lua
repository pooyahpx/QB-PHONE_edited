...
Citizen.CreateThread(function()
	...
	while true do
		...
		if IsControlJustPressed(1, Keys["BACKSPACE"]) or IsControlJustPressed(1, 177) and phone == true then 
			DestroyMobilePhone()
			phone = false
		...
		if IsControlJustPressed(1, Keys["TOP"]) and phone == true then 
			frontCam = not frontCam
			CellFrontCamActivate(frontCam)
		end
		
		if IsControlJustPressed(1, 176) and phone == true then 
			TakePhoto()
