...
RegisterNUICallback('GetCurrentpolices', function(data, cb)
    QBCore.Functions.TriggerCallback('qb-phone_new:server:GetCurrentpolices', function(lawyers)
        cb(lawyers)
    end)
end)

RegisterNUICallback("GetCurrentDrivers", function(data, cb)
    QBCore.Functions.TriggerCallback('qb-phone_new:server:GetCurrentDrivers', function(drivers)
        cb(drivers)
    end)
end)